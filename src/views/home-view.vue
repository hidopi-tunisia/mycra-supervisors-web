        ...
        <div class="row">
              ...
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  <div class="avatar flex-shrink-0">
                    <div class="avatar flex-shrink-0 bg-consultants rounded-avatar">
                      <i class="bx bxs-user-badge fs-4 lh-0 text-danger"></i>
                    </div>
                  </div>
                  <div class="dropdown">
                    <button
          ...
          <div class="col-3 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  <div class="avatar flex-shrink-0">
                    <div class="avatar flex-shrink-0 bg-clients rounded-avatar">
                      <i class="bx bxs-user-circle fs-4 lh-0 text-success"></i>
                    </div>
                  </div>
                  <div class="dropdown">
                    <button
          ...
          <div class="col-3 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  <div class="avatar flex-shrink-0">
                    <div class="avatar flex-shrink-0 bg-cras rounded-avatar">
                      <i class="bx bxs-calendar fs-4 lh-0 text-warning"></i>
                    </div>
                  </div>
                  <div class="dropdown">
                    <button
                ...
                <span class="fw-semibold d-block mb-1">CRAs</span>
                <h3 class="card-title mb-2">$14,857</h3>
                <small class="text-success fw-semibold"
                  ><i class="bx bx-up-arrow-alt"></i> +28.14%</small
                >
          ...
          <div class="col-3 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  <div class="avatar flex-shrink-0 bg-projects rounded-avatar">
                    <i class="bx bx-user fs-4 lh-0 text-info"></i>
                  </div>
                  <div class="dropdown">
                    <button
                      class="btn p-0"
